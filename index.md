...
> ### 컨셉 기반: 분노유발: 맵을 움직이면서 여러 장애물로 인해 죽으면서 자신의 플레이의 화가 날 수 있는 게임을 하는걸 원함.
...
### 시간별 캐릭터 흐름도
 <img src="./img/캐릭터 상태 관련 흐름도.png">

# c2.시간별흐름도 <a name='#키보드_이벤트에_대한_흐름도'></a>
### 키보드흐름도
 <img src="./img/keyevent.png">
 
 # 9. [개발작업 일정(6주)] <a name='#개발작업_일정(6주)'></a>
 ### 개발작업 일정
  <img src="./img/개발작업 일정1.png">
