...
#### b2. [키보드 이벤트에 대한 흐름도](#키보드_이벤트에_대한_흐름도)
#### c2. [용어정리](#용어정리)
...
> ### 컨셉 기반: 분노유발: 맵을 움직이면서 여러 장애물로 인해 죽으면서 
...
# a. 게임 오브젝트 분해 (구성 요소 분석) <a name='게임 오브젝트 분해'></a>
...
-세이브포인트는 죽을 때마다 사용할 지 말지 결정할 수 있게 한다.
-세이브지점은 삭제할 수 없고 새로운 세이브포인트를 발견해야 갱신된다.

# [개발 요구사항 & 흐름도] <a name='8'></a>
# a2. 요구사항 <a name='요구사항'></a>
# a2-1. 요구사항(6주)
...
# a2-2. 요구사항(1년)
 - 
# b2.키보드흐름도 <a name='키보드흐름도'></a>
-키보드흐름도
 <img src="./img/keyevent.png">
 
 ### 9. [개발작업 일정(6주)] <a name='#개발작업 일정(6주)'></a>
